...
The primary aim of this project is to gain insight into the sales data of Walmart to understand the different factors that affect sales of the various branches.
...
For the rest of the code, check the [MySQL_Queries.sql](https://github.com/Shashank-Shivakumar/Walmart-SalesAnalysis/blob/main/MySQL_Queries.sql) file
